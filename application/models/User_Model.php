...
class User_Model extends CI_Model{
	...
	public function insertar_aviso_problema($arreglo){
		$consulta="INSERT INTO aviso_problema(tipo_aviso,item_relacionado_aviso,descripcion_aviso) 
	...
	public function items(){
		$consulta="	SELECT id_item,descripcion_item FROM ITEM
					WHERE
					tipo_item!='MONITOR' AND
					tipo_item!='MOUSE' AND
					tipo_item!='TECLADO' AND
					tipo_item!='RAM' AND
					tipo_item!='PROCESADOR' AND
					tipo_item!='HDD' AND
					tipo_item!='MOTHERBOARD' AND
					tipo_item!='FUENTE PODER'
					";
		$respuesta=$this->db->query($consulta);
		if($respuesta) return $respuesta;
		else return FALSE;
